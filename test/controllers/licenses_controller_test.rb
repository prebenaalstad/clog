...
class LicensesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create license" do
    assert_difference('License.count') do
      post licenses_url, params: { license: { expiration: @license.expiration, name: @license.name, notify: @license.notify } }
    end
  ...
  test "should update license" do
    patch license_url(@license), params: { license: { expiration: @license.expiration, name: @license.name, notify: @license.notify } }
